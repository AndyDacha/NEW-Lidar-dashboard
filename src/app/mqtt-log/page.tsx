        ...
        <div className="bg-gray-50 rounded-lg shadow p-6 mb-8">
          ...
          <div className="mt-4 p-4 bg-white rounded-lg border border-gray-200">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              This page monitors the real-time connection status of the MQTT server. The system actively checks the connection every minute and logs all status changes. The status is determined by both active polling and real-time MQTT events. The connection history table below shows the last 50 status changes, including timestamps and reasons for each change. This helps track the stability and reliability of the MQTT connection over time.
            </p>
          </div>
        </div>
