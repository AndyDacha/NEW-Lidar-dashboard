    ...
    <div className="min-h-screen bg-white p-6">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <section className="bg-gray-50 rounded-xl shadow p-6">
          ...
          <strong>Logic:</strong> The system polls the MQTT connection every minute and listens for status events. All changes are logged with timestamps and reasons for each change.</p>
        </section>
        {/* System Alerts */}
        <section className="bg-gray-50 rounded-xl shadow p-6">
